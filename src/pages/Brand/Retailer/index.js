  ...
  return (
    <div className={`'' ${subTab == 1 ? 'sidebar-hidden' : ''}`}>
      <div className="wrapper">
        <BrandHeader tab={3} subTabs={subTab} changeSubTab={changeSubTab} />
          ...
          >
            ...
            {subTab == 1 && (
              <>
                  ...
                  <div className="filters_wrap">
                    <div className="filters_block filters_block-head">
                      ...
                      <button
                        ...
                        onClick={() => childRef.current.handleClearFilter()}
                      >
                        Clear Filters
                      </button>
                    </div>
                      ...
                      <div className="filter open filter-by-products">
                        <div className="filter_body pt-3 pb-5">
                          <ConnectedFilter
                            ...
                            setOpenSideFilter={setOpenSideFilter}
                ...
                <Connected height={height} changeSubTab={changeSubTab} />
              </>
            )}
          </section>
        </main>
            ...
            <div className="popup_wrapper">
              <div className="popup_content">
                <div className="popup-close">
                  <img
                    src={closeBlackIcon}
                    onClick={() => setOpenInviteretailer(!openInviteRetailer)}
                  />
                </div>
                ...
                <form className="primary__form form form_retailers">
                  <div className="form_retailers-left">
                    <div className="form_field">
                      <span>Add retailer email address</span>
                      <input
                        type="email"
                      ...
                      <div className="form_field-help">
                        <small>
                          Don’t worry, the brands won’t see the other
                          recipients.
                        </small>
                      </div>
                    </div>
                  ...
                  <div className="form_retailers-right">
                    ...
                    <div className="form_field">
                      ...
                      >
                        Hi, it&apos;s Michelle Huie from Vim &amp; Vigr. I just
                        signed up for <a href="#">ShopDot</a>, a brand-to-retail
                        platform that integrates with my Shopify store to
                        Distribute products with ease and streamline inventory
                        and drop-shipping. <br />
                        <br />
                        I&apos;m interested in partnering with you through{' '}
                        <a href="#">ShopDot</a>. To learn more about the
                        benefits of selling on ShopDot,{' '}
                        <a href="#">click here</a>. <br />
                        <br />
                        Here&apos;s my brand profile:{' '}
                        <a href="#">wwww.shopdot.com/brand/profile</a>
                      </div>
                    </div>
                    ...
                    <div className="form_field form_field-help">
                      <div className="later">
                        <a
                          ...
                          onClick={() =>
                            setOpenInviteretailer(!openInviteRetailer)
                          }
                        >
