        ...
        productArray.forEach((e) => {
            ...
            if (e === 'productTagFilter') {
                productFilter.productTagFilter?.map((ele) => {
                    (productCatData.length === 0 ? Data : productCatData).map(
                        (e) => {
                    ...
                    <div className="products_head-content">
                        ...
                        <div className="products_head-brand-types">
                            ...
                            <a
                                href="#"
                                className={`brand-type ${
                                    productFilter?.statusViseFilter[0] ===
                                    'active'
                                        ? 'active'
                                        : ''
                                }`}
                                onClick={() =>
                                    productStatusViseFilter('active')
                                }
                            >
                                Active
                            </a>
                            <a
                                ...
                                onClick={() =>
                                    productStatusViseFilter('inactive')
                                }
                            >
                                Inactive
                            </a>
