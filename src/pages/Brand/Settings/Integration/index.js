                  ...
                  <div className="popup_content">
                      ...
                      <div className="popup_content-body text-center">
                          <p className="mb-4 shopify-subtext">
                              Make sure you fulfill all open orders in
                              Shopify before disconnecting ShopDot.
                          </p>
                          <p className="shopify-note">
                              <span>Please note:</span> Your brand profile
                              and products will not be displayed to
                              retailers in ShopDot and new orders cannot
                                  ...
                                  {!isStoreConnected && !storeStatus && (
                                      <div className="integration_item">
                                          ...
                                          >
                                              ...
                                              />
                                              <div>
                                                  Your brand profile is
                                                  not visible to retailers
                                                  because your Shopify
