      ...
      <div className="form-area">
        <div className="form-input">
          ...
          <label className="form-data">
            {get(bankDetails, 'account_holder_name', '-')}
          </label>
        </div>
        <div className="form-input">
          <label htmlFor="" className="form-label">
          ...
          <label className="form-data">
            {get(bankDetails, 'account_type.label', '-')}
          </label>
        </div>
        <div className="form-input">
          <label htmlFor="" className="form-label">
        ...
        <div className="form-input">
          ...
          <label className="form-data account-number">
            {get(bankDetails, 'account_number', '-')}
            {/* {hideAccountNumber(
        ...
        <div className="form-input">
          ...
          <label className="form-data">
            {get(bankDetails, 'routing_number', '-')}
          </label>
        </div>
      </div>
    </div>
