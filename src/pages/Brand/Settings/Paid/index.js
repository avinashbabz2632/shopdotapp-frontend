...
export default function BrandPaid() {
    ...
    const [gettingPaidDetails, setGettingPaidDetails] = useState({});
        ...
        return (
            <>
                <div className="form-input preferences-item">
                    <h4>
                        ShopDot, Inc. works with Priority Technology Holdings,
                        Inc. (&quot;PRTH&quot;) to provide merchant accounts for
                        businesses just like you. Priority provides a valuable
                        service which includes processing your customer&apos;s
                        payment transactions and depositing the funds into your
                        account. To enable merchant account services through
                        Priority, please complete the following application.{' '}
                    </h4>
                    <button
                        onClick={() => {
                            setStartingTab(true);
                ...
                <div className="form-input">
                    <div className="gp-info">
                        <div className="gpinfo-item">
                            ...
                            <p>
                                You will be asked to provide standard business
                        ...
                        <div className="gpinfo-item">
                            ...
                            <p>
                                It will take 5-10 minutes to complete this
                                application{' '}
                            </p>
                        </div>
                    </div>
