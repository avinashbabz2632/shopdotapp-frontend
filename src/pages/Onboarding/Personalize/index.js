                    ...
                    <div className="form-area">
                        <div className="form-group personalize">
                            <p className="p-text mb-0">
                                You are creating an account as a..
                            </p>
                            <div className="personalize_selection">
                                ...
                                >
                                    ...
                                    <p>
                                        I would like to use ShopDot to offer
                                        product listing content, on-demand
                                        inventory and drop-shipping to my
                                        retailers.
                                    </p>
                                </div>
                                <div
                                ...
                                >
                                    ...
                                    <h3>RETAILER</h3>
                                    <p>
                                        I would like to use ShopDot to tap into
                                        the product listing content, inventory
                                        and drop-shipping capabilities of my
                                        brand suppliers.
                                    </p>
                                </div>
                            </div>
                            {supplier && supplier === 1 && platform !== 2 ? (
                                <div className="category-form-input integrate-area mt-5">
                                    <div className="form-input">
                                        <label
                                            htmlFor=""
                                            className="form-label text-navy mb-0"
                                        >
                                        ...
                                        <small className="info-integrate">
                                            As a Brand Supplier, ShopDot will
                                            sync your products to your retailers
